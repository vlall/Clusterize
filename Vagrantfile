...
10.191.90.100   vm-cluster-node1
10.191.90.101   vm-cluster-node2
10.191.90.102   vm-cluster-node3
10.191.90.103   vm-cluster-node4
10.191.90.104  vm-cluster-node5
10.191.90.105   vm-cluster-client
EOF
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :master do |master|
    ...
    master.vm.network :private_network, ip: "10.191.90.100"
  ...
  config.vm.define :slave1 do |slave1|
    ...
    slave1.vm.network :private_network, ip: "10.191.90.101"
  ...
  config.vm.define :slave2 do |slave2|
    ...
    slave2.vm.network :private_network, ip: "10.191.90.102"
  ...
  config.vm.define :slave3 do |slave3|
    ...
    slave3.vm.network :private_network, ip: "10.191.90.103"
  ...
  config.vm.define :client do |client|
    ...
    client.vm.network :private_network, ip: "10.191.90.105"
